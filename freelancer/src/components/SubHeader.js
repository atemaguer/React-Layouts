    ...
    return (
        <Row type="flex" justify="space-between" align="center"  style={{marginTop:12, marginRight:40, marginBottom:24, alignItems:"center"}} gutter={24}>
           <Col span={15}>
            ...
            <Col span={3}>
                <Row type="flex">
                    <Card bodyStyle = {{display:"flex", justifyContent:"space-between", alignItems:"center",padding:16, boxShadow: "0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)", borderRadius:4}} bordered={false}>
            ...
            <Col span={6}>
                    <Row type="flex" gutter={8} style={{backgroundColor:"rgb(213, 215, 222)", padding:8, borderRadius:4}}>
                        <Col span={12}>
